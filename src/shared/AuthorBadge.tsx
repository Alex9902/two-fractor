  ...
  return (
    <div className={`inline-flex items-center gap-1.5 text-xs font-black uppercase text-black/70 my-3 sm:my-4 ${className}`}>
      ...
      <a
        ...
        target="_blank"
        rel="noreferrer"
        className="inline-flex items-center gap-1 cursor-pointer bg-white border-2 border-black px-2 py-0.5 rounded shadow-[1.5px_1.5px_0px_0px_rgba(0,0,0,1)] transition-transform hover:scale-105 active:translate-x-[1px] active:translate-y-[1px]"
